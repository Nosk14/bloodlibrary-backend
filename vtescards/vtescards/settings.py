"""
Django settings for vtescards project.
...
WSGI_APPLICATION = 'vtescards.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'vtescards',
        'USER': 'alucard', #os.getenv('DB_USER', 'test'),
        'PASSWORD': 'AguasNegras2020', #os.getenv('DB_PASSWORD', 'test'),
        'HOST': '92.222.81.25',
