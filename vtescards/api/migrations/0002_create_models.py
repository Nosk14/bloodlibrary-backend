    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expansion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.expansion')),
            ],
        ),
        migrations.AddField(
            model_name='card',
            name='publish_expansions',
            field=models.ManyToManyField(blank=True, through='api.CardExpansion', to='api.Expansion'),
        ),
    ]
